...
class Ap1Ind5aHistController extends Controller
{
	/**
	  ...
	  public function actionPrevio($id)
    {
        ...
        $model=Ap1Ind5aHist::model()->findByPk($id);
	 ...
	 */
	   public function actionIndex() {
        ...
        $item_count = Ap1Ind5aHist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind5aHist::model()->findAll($criteria);
