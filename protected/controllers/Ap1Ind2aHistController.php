...
class Ap1Ind2aHistController extends Controller
{
	/**
	  ...
	  public function actionPrevio($id)
    {
       ...
       // $baseUrl = YiiBase::getPathOfAlias("webroot");
        $url = "http://localhost/recm/index.php/api2/ap1Ind2a?id=$id";
        //$url = $baseUrl;
	 ...
	 */
	   public function actionIndex() {
        ...
        $item_count = Ap1Ind2aHist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind2aHist::model()->findAll($criteria);
