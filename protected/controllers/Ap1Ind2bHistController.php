...
class Ap1Ind2bHistController extends Controller
{
	/**
	  ...
	  public function actionPrevio($id)
    {
        ...
        $model=Ap1Ind2bHist::model()->findByPk($id);
	 ...
	 */
	   public function actionIndex() {
        ...
        $item_count = Ap1Ind2bHist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind2bHist::model()->findAll($criteria);
