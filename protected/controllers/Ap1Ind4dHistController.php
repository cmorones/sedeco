...
class Ap1Ind4dHistController extends Controller
{
	/**
	  ...
	  public function actionPrevio($id)
    {
        ...
        $model=Ap1Ind4dHist::model()->findByPk($id);
	 ...
	 */
	   public function actionIndex() {
        ...
        $item_count = Ap1Ind4dHist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind4dHist::model()->findAll($criteria);
