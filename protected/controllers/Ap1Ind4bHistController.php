...
class Ap1Ind4bHistController extends Controller
{
	/**
	  ...
	  public function actionPrevio($id)
    {
        ...
        $model=Ap1Ind4bHist::model()->findByPk($id);
       // $baseUrl = YiiBase::getPathOfAlias("webroot");
        $url = "http://localhost/recm/index.php/api2/ap1Ind4b?id=$id";
        //$url = $baseUrl;
	 ...
	 */
	   public function actionIndex() {
        ...
        $item_count = Ap1Ind4bHist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind4bHist::model()->findAll($criteria);
