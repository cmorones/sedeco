...
$('.search-form form').submit(function(){
	$('#ap4-ind4-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            'name'=>'entidad',
             'value'=>'HistoricoPeriodos::model()->getEntidad($data->entidad, $data->entidad)',
		...
		array(
		    ...
		    (
		        ...
		        (
		            ...
		            'url'=>'Yii::app()->createUrl("ap4Ind4/borrar", array("id"=>$data->id))',
		            'options' => array(
