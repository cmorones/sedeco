...
$('.search-form form').submit(function(){
	$('#ap4-ind12a-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            'name'=>'rubro2',
            'value'=>'HistoricoPeriodos::model()->getRelacion($data->rubro2,"ap4Ind12r1a")',
            //'htmlOptions'=>array('style'=>'width:120px;  text-align:center;'),
                    ),
		array(
            'name'=>'rubro',
            'value'=>'HistoricoPeriodos::model()->getRelacion($data->rubro,"ap4Ind12r2a")',
            //'htmlOptions'=>array('style'=>'width:120px;  text-align:center;'),
                    ),
		'valor',
		...
		array(
		    ...
		    (
		        ...
		        (
		            ...
		            'url'=>'Yii::app()->createUrl("ap4Ind12a/borrar", array("id"=>$data->id))',
		            'options' => array(
