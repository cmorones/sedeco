...
$sql_lid="SELECT MAX(id) as id  FROM ap7Ind2";
...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'rubro',CHtml::listData(Relaciones::model()->findAll(array("condition"=>"indicador =  'ap7Ind2'")), 'columna', 'titulo'),array ('prompt'=>'Seleccione...'));?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'estructura'); ?>
