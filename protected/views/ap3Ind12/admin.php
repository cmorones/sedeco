...
$('.search-form form').submit(function(){
	$('#ap3-ind12-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            'name'=>'delegacion',
            'value'=>'HistoricoPeriodos::model()->getDelegacion($data->delegacion)',
            'htmlOptions'=>array('style'=>'width:120px;  text-align:center;'),
                    ),
		array(
            'name'=>'rubro',
            'value'=>'HistoricoPeriodos::model()->getRelacion($data->rubro,"ap3Ind12")',
            'htmlOptions'=>array('style'=>'width:120px;  text-align:center;'),
                    ),
		array(
            'name'=>'valor',
		...
		array(
		    ...
		    (
		        ...
		        (
		            ...
		            'url'=>'Yii::app()->createUrl("ap3Ind12/borrar", array("id"=>$data->id))',
		            'options' => array(
