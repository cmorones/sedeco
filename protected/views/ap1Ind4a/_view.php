...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('tipo_serie')); ?>:</b>
	<?php echo CHtml::encode($data->tipo_serie); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('total_act')); ?>:</b>
	<?php echo CHtml::encode($data->total_act); ?>
	<br />
