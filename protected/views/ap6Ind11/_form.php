...
$sql_lid="SELECT MAX(id) as id  FROM ap6Ind11";
...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'rubro',CHtml::listData(Relaciones::model()->findAll(array("condition"=>"indicador =  'ap6Ind11'")), 'columna', 'titulo'),array ('prompt'=>'Seleccione...'));?>
