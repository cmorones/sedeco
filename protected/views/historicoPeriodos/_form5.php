...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="HistoricoPeriodos_anios_ini">Año inicial:</label>
		<div class="col-sm-10">
			<?php
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="HistoricoPeriodos_anios_ini">Año final:</label>
		<div class="col-sm-10">
			<?php
			    echo $form->dropDownList(
			        $model, 
	...
	<div class="row">
		<h4>Rango de Meses:</h4>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="HistoricoPeriodos_meses_ini">Mes inicial:</label>
		<div class="col-sm-10">
			<?php
			    echo $form->dropDownList(
			        $model, 
			        'mes_ini', 
			        CHtml::listData( CatMeses::model()->findAll(),'id','nombre' ), 
			        [
			            'class' => 'my-drop-down',
			            'options' => [
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="HistoricoPeriodos_meses_ini">Mes final:</label>
		<div class="col-sm-10">
			<?php
			    echo $form->dropDownList(
			        $model, 
	...
	<style>
	#HistoricoPeriodos_config_39,
	#HistoricoPeriodos_config_40
	{
	  display: none;
	}
	</style>
	<script>
		$(document).ready(function(){
			$('#HistoricoPeriodos_config_39, label[for="HistoricoPeriodos_config_39"]').hide();
			$('#HistoricoPeriodos_config_40, label[for="HistoricoPeriodos_config_40"]').hide();
		});
	</script>
	<div class="row">
		<h4>Entidades para mostrar en este indicador:</h4>
				<?php
			    echo $form->checkBoxList(
			        $model, 
			        'config', 
			        CHtml::listData( Entidades::model()->findAll(),'id','nombre' ),array(
						'separator' => '<br/>',
						'class'=>'checkBoxClass',
					)
			        );
