...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="HistoricoPeriodos_anios_fin">Año final:</label>
		<div class="col-sm-10">
			<?php
			    echo $form->dropDownList(
			        $model, 
	...
	<div class="row"> 	
		<h4>Meses para mostrar en este indicador</h4>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="HistoricoPeriodos_config">Meses:</label>
		<div class="col-sm-10">
			<?php
			    echo $form->checkBoxList(
			    $model, 
			    'config', 
			    CHtml::listData( CatMeses::model()->findAll(),'id','nombre' ),array(
					'separator' => '',
					'class'=>'checkBoxClass',
				)
			    );
