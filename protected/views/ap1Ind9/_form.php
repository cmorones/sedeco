...
$sql_lid="SELECT MAX(id) as id  FROM ap1Ind9";
...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'rubro',CHtml::listData(Relaciones::model()->findAll(array("condition"=>"indicador =  'ap1Ind9'")), 'columna', 'titulo'),array ('prompt'=>'Seleccione...'));?>
