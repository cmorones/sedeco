...
$grafico= $baseUrl2.'/static/ap1Ind10.json';
...
<!-- aqui va el contenido -->
  ...
  <script type="text/javascript">
	    ...
	    series: [
			...
			$.getJSON("<?=$baseUrl?>/index.php/api/ap3Ind31g2?anios=<?php echo $a; ?>&serie=1&grafico=1&<?php echo 'periodo='.$periodo; ?>", function(json) {
