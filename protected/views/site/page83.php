...
//******estos son los promedios del periodo a consultar
 ...
 <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap2Ind3a?periodo='.$periodo.'&tipo=1')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap2Ind3a?periodo='.$periodo.'&tipo=2')); ?>
                       </div>   
</div> 
