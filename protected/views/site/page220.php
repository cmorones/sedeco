...
$var = HistoricoPeriodos::model()->listaSimple($rango);

//FIN DE LA CONFIG

$baseUrl = Yii::app()->params['baserecm'];
$url = $baseUrl. "/index.php/api/ap1Ind82?anios=$var&grafico=0&periodo=".$periodo;
//$url = $baseUrl;
                    ...
                    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-3" aria-expanded="false">
                      <ul class="nav navbar-nav">
                        ...
                        <li >              
                         ...
                         <li >    
                            <?php
                                echo CHtml::link('Exportaciones de la industria manufacturera del Distrito Federal', array('site/main/61'));
                              ?>
                      </li>
...
<div class="table-responsive">
        ...
        <table class="table600600 table-bordered table-condensed defaultTable">
                ...
                <tr class="rEven">
                        <td>Subsector de Avtividad Econónica</td>
                ...
                if (is_array($valor2)){ 
                    foreach ($valor2 as $indice3 => $valor3) {
                        ...
                        if($indice3>1){
                            ...
                            echo"<tr class='rEven'><td class=''>".  utf8_encode($rubro['titulo'])."</td><td class='data'>".number_format(($valor3['total']/$divisor),0)."</td><td  class='data'>".round(((($valor3['total']/$divisor)/$gran_total)*100),1)."%</td></tr>";
                        }
