...
if($cadena<1){
  ...
  $baseUrl = Yii::app()->params['baserecm'];
  $texto=$baseUrl."/index.php/api/ap8Ind13_textos?anios_ini=".$config['anios_ini']."&anios_fin=".$config['anios_fin']."&serie=1&grafico=1&periodo=".$periodo; 

  $serie1=$baseUrl."/index.php/api/ap8Ind13?anios_ini=".$config['anios_ini']."&anios_fin=".$config['anios_fin']."&serie=1&grafico=1&periodo=".$periodo;
  $serie2=$baseUrl."/index.php/api/ap8Ind13?anios_ini=".$config['anios_ini']."&anios_fin=".$config['anios_fin']."&serie=2&grafico=1&periodo=".$periodo; 
  ...
  if($periodox==""){
    echo "LA config debe ser igual a la del indicador de Historico de comercio";
  }
  ...
  $baseUrl = Yii::app()->params['baserecm'];
  $texto=$baseUrl."/index.php/api/ap8Ind13_textos?anios_ini=".$config['anios_ini']."&anios_fin=".$config['anios_fin']."&serie=1&grafico=1&periodo=".$periodox; 
  $text = file_get_contents($texto);

  $serie1=$baseUrl."/index.php/api/ap8Ind13?anios_ini=".$config['anios_ini']."&anios_fin=".$config['anios_fin']."&serie=1&grafico=1&periodo=".$periodox;
  $serie2=$baseUrl."/index.php/api/ap8Ind13?anios_ini=".$config['anios_ini']."&anios_fin=".$config['anios_fin']."&serie=2&grafico=1&periodo=".$periodox; 
}
...
<div class="col-md-12 text-center">
    <h3>Indicador mensual de comercio al por mayor</h3>
