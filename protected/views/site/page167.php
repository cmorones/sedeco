...
?>
   <tr class="rEven"> 
       ...
       <td colspan="2"><?php echo $titulos['titulo2']; ?></td>
    ...
    <tr class="rEven"> 
        ...
        <tr class="rEven"> 
            <?php  
                ...
                echo "<td class='data'>".number_format($datos['ejercicio'],2)."</td><td class='data'>".number_format($datos['estructura'],2)."%</td>";
        ...
        <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap7Ind2?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap7Ind2?periodo='.$periodo.'&tipo=2')); ?>
                       </div>
