...
?>
    ...
    <tr class="rEven"> 
        ...
        <td colspan="2">Trimestre <?php echo $config['anios_fin'].".".$key; ?></td>
    ...
    <tr class="rEven"> 
        ...
        <td>Variación % respecto al <?php echo $key; ?> trimestre del <?php echo ($anio-1); ?></td>
        <?php }} ?>
    </tr>
    ...
    <tr class="rEven">
        ...
        <td class="data"><?php echo round((($datos[$anio][$key]['df']/$datos[$anio_ref][$key]['df'])-1)*100,1); ?></td>
        <?php }} ?>
    </tr>   
    ...
    <tr class="rEven">
        ...
        <td class="data"><?php echo round((($datos[$anio][$key]['nacional']/$datos[$anio_ref][$key]['nacional'])-1)*100,1); ?></td>
        <?php }} ?>
    </tr>   
 ...
 <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap4Ind2?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap4Ind2?periodo='.$periodo.'&tipo=2')); ?>
                       </div>			        
