...
//******estos son los promedios del periodo a consultar
            echo "<tr class='rEven'><td>Promedio</td>";
                echo "<td class='data'>".number_format($datos['promedios']['promdf'],0)."</td><td class='data'>".round($promedio_df,0)."</td><td class='data'>".number_format($datos['promedios']['promnal'],0)."</td><td class='data'>".round($promedio_nacional,0)."</td>";
            echo "</tr>";
  ...
  <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap6Ind2?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap6Ind2?periodo='.$periodo.'&tipo=2')); ?>
                       </div>
