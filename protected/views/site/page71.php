                  ...
                  <div class="navbar-header">
                    ...
                    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-3" aria-expanded="false">
                      <ul class="nav navbar-nav">
                            ...
                            <li >      
                                  <?php
                                    echo CHtml::link('Índice General de Precios al consumidor', array('site/main/71'));
                                  ?>
                            </li>

                            <li >      
                                  <?php
                                    echo CHtml::link('Histórico Índice General de Precios al consumidor', array('site/main/72'));
                                  ?>
                            </li>
...
<div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap2Ind1?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap2Ind1?periodo='.$periodo.'&tipo=2')); ?>
                       </div>  
