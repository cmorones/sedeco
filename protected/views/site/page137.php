...
?>
    ...
    <tr class="rEven">
        ...
        <td class="data"><?php echo number_format($dato['total']['valor'],0)?></td>
        <td class="data"><?php echo number_format(($dato['total']['valor']/$datos['rubro'][21]['total']['valor'])*100,2)?></td>
    ...
    <?php } ?>
               ...
               <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap5Ind22?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap5Ind22?periodo='.$periodo.'&tipo=2')); ?>
                       </div> 
