...
?>  
    ...
    <tr class="rEven">
        ...
        <?php } ?>
        <td class="data"><?php echo number_format($datos['delegacion'][$delegacion]['total'],0);?></td>
    </tr> 
    <?php } ?>
		 ...
		 <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap4Ind11?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap4Ind11?periodo='.$periodo.'&tipo=2')); ?>
                       </div>	        
