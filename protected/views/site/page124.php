...
?>
   <tr class="rEven"> 
                ...
                switch ($i){
                   ...
                   case 12:
                    ...
                    <?php foreach ($ent as $e){ 
                        ...
                        <td class="data"><?php echo round($datos[$e]['mes'][$i]['valor'],2); ?></td> 
     ...
     <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap4Ind31?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap4Ind31?periodo='.$periodo.'&tipo=2')); ?>
                       </div> 
