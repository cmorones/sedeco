...
?>  
    ...
    <?php  foreach($datos['rubro'][1]['delegacion'] as $delegacion=>$valores){ ?>
        ...
        <td >Número de unidades económicas</td>
        <td >%</td>
 ...
 <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap5Ind23?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap5Ind23?periodo='.$periodo.'&tipo=2')); ?>
                       </div> 
