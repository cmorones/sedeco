...
$baseUrl = Yii::app()->params['baserecm'];
$texto=$baseUrl."/index.php/api/ap7Ind14_textos?anios_ini=".$config['anios_ini']."&anios_fin=".$config['anios_fin']."&serie=1&grafico=1&periodo=".$periodo; 
  ...
  <script type="text/javascript">
    ...
    lang: {
		...
		yAxis: {
                ...
                $.getJSON("<?=$baseUrl?>/index.php/api/ap7Ind14?anios_ini=<?php echo $config['anios_ini']; ?>&anios_fin=<?php echo $config['anios_fin']; ?>&serie=1&grafico=1&<?php echo 'periodo='.$periodo; ?>", function(json) {
