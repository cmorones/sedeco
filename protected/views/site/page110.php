...
?>
    ...
    <tr class="rEven">
        ...
        <td>Trimestre <?php echo $config['anios_ini'].".".$k; ?></td>
        <?php } ?>
    </tr>        
    ...
    <tr class="rEven">
     ...
     if($key==1){       
        switch ($rubro){
            case 1:
                echo "<td>Distrito Federal</td>";
                break;
            case 2:
                echo "<td>Nacional (total)</td>";
                break;
            case 3:
                echo "<td>Nacional áreas más urbanizadas</td>";
                break;
        }
 ...
 <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap3Ind5?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap3Ind5?periodo='.$periodo.'&tipo=2')); ?>
                       </div>
