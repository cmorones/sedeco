...
//echo $config['anios_fin'];
		
$id2=86;
$baseUrl = Yii::app()->params['baserecm'];
$texto=$baseUrl."/index.php/api/ap3Ind31g1_textos?anios=".$a."&serie=1&grafico=1&periodo=".$periodo; 
...
<!-- aqui va el contenido -->
  ...
  <script type="text/javascript">
	    ...
	    series: [
			...
			$.getJSON("<?=$baseUrl?>/index.php/api/ap3Ind31g1?anios=<?php echo $a; ?>&serie=1&grafico=1&<?php echo 'periodo='.$periodo; ?>", function(json) {
				options.series[0].data = json;
                chart = new Highcharts.Chart(options);
        });

        $.getJSON("<?=$baseUrl?>/index.php/api/ap3Ind31g1?anios=<?php echo $a; ?>&serie=2&grafico=1&<?php echo 'periodo='.$periodo; ?>", function(json2) {
   ...
   <div class="option_1">
              ...
              <?php } ?>
		        	...
		        	<div class="table_explanation col-md-12">
