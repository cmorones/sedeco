...
<div class="table-responsive">
        ...
        <table class="table400 table-bordered table-condensed table400">
...
?>
        ...
        <?php } ?>    
          ...
          <div align="right"><?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/pdf.png'),array('apipdf/ap5Ind4?periodo='.$periodo.'&tipo=1'),array('target'=>'_blank')); ?>
<?   echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl . '/images/excel.png'),array('apipdf/ap5Ind4?periodo='.$periodo.'&tipo=2')); ?>
                       </div> 
