...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('nombre_btn')); ?>:</b>
	<?php echo CHtml::encode($data->nombre_btn); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('id_apartado')); ?>:</b>
	<?php echo CHtml::encode($data->id_apartado); ?>
	<br />
