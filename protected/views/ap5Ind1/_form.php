...
$sql_lid="SELECT MAX(id) as id  FROM ap5Ind1";
...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'rubro',CHtml::listData(Relaciones::model()->findAll(array("condition"=>"indicador =  'ap5Ind1'")), 'columna', 'titulo'),array ('prompt'=>'Seleccione...'));?>
