...
/**
 * This is the model class for table "ap8Ind21".
 *
 * The followings are the available columns in table 'ap8Ind21':
 * @property integer $id
 ...
 */
class Ap8Ind21 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('unidades, personal', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, anio, rubro, unidades, personal, fecha_reg, fecha_mod, user_reg, user_mod, periodo_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap8Ind21 the static model class
	 */
