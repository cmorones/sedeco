...
/**
 * This is the model class for table "ap1Ind4b_hist".
 *
 * The followings are the available columns in table 'ap1Ind4b_hist':
 * @property integer $id
 ...
 */
class Ap1Ind4bHist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind4bHist the static model class
	 */
