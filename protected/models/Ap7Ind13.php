...
/**
 * This is the model class for table "ap7Ind13".
 *
 * The followings are the available columns in table 'ap7Ind13':
 * @property integer $id
 ...
 */
class Ap7Ind13 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap7Ind13 the static model class
	 */
