...
/**
 * This is the model class for table "ap1Ind82".
 *
 * The followings are the available columns in table 'ap1Ind82':
 * @property integer $id
 ...
 */
class Ap1Ind82 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind82 the static model class
	 */
