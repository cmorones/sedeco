...
/**
 * This is the model class for table "ap1Ind4c_hist".
 *
 * The followings are the available columns in table 'ap1Ind4c_hist':
 * @property integer $id
 ...
 */
class Ap1Ind4cHist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind4cHist the static model class
	 */
