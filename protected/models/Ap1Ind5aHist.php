...
/**
 * This is the model class for table "ap1Ind5a_hist".
 *
 * The followings are the available columns in table 'ap1Ind5a_hist':
 * @property integer $id
 ...
 */
class Ap1Ind5aHist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind5aHist the static model class
	 */
