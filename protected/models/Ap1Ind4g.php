...
/**
 * This is the model class for table "ap1Ind4g".
 *
 * The followings are the available columns in table 'ap1Ind4g':
 * @property integer $id
 ...
 */
class Ap1Ind4g extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, user_reg, user_mod, periodo_id', 'numerical', 'integerOnly'=>true),
			array('valor', 'numerical'),
			array('anio, rubro', 'length', 'max'=>100),
	 ...
	 * @return Ap1Ind4g the static model class
	 */
