...
/**
 * This is the model class for table "ap3Ind2".
 *
 * The followings are the available columns in table 'ap3Ind2':
 * @property integer $id
 ...
 */
class Ap3Ind2 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap3Ind2 the static model class
	 */
