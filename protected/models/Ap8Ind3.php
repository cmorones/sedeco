...
/**
 * This is the model class for table "ap8Ind3".
 *
 * The followings are the available columns in table 'ap8Ind3':
 * @property integer $id
 ...
 */
class Ap8Ind3 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap8Ind3 the static model class
	 */
