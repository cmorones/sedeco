...
/**
 * This is the model class for table "ap7Ind14".
 *
 * The followings are the available columns in table 'ap7Ind14':
 * @property integer $id
 ...
 */
class Ap7Ind14 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap7Ind14 the static model class
	 */
