...
/**
 * This is the model class for table "ap1Ind3_hist".
 *
 * The followings are the available columns in table 'ap1Ind3_hist':
 * @property integer $id
 ...
 */
class Ap1Ind3Hist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind3Hist the static model class
	 */
