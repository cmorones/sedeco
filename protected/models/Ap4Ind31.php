...
/**
 * This is the model class for table "ap4Ind31".
 *
 * The followings are the available columns in table 'ap4Ind31':
 * @property integer $id
 ...
 */
class Ap4Ind31 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, anio, mes, entidad, columna, user_reg, user_mod, periodo_id', 'numerical', 'integerOnly'=>true),
			array('valor', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, anio, mes, entidad, valor, columna, fecha_reg, fecha_mod, user_reg, user_mod, periodo_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap4Ind31 the static model class
	 */
