...
/**
 * This is the model class for table "ap1Ind9".
 *
 * The followings are the available columns in table 'ap1Ind9':
 * @property integer $id
 ...
 */
class Ap1Ind9 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind9 the static model class
	 */
