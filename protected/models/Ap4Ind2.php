...
/**
 * This is the model class for table "ap4Ind2".
 *
 * The followings are the available columns in table 'ap4Ind2':
 * @property integer $id
 ...
 */
class Ap4Ind2 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap4Ind2 the static model class
	 */
