...
/**
 * This is the model class for table "ap3Ind31g2".
 *
 * The followings are the available columns in table 'ap3Ind31g2':
 * @property integer $id
 ...
 */
class Ap3Ind31g2 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, anio, mes, rubro, valor, fecha_reg, fecha_mod, user_reg, user_mod', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap3Ind31g2 the static model class
	 */
