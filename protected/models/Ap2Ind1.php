...
/**
 * This is the model class for table "ap2Ind1".
 *
 * The followings are the available columns in table 'ap2Ind1':
 * @property integer $id
 ...
 */
class Ap2Ind1 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, anio, mes, df, nacional, fecha_reg, fecha_mod, user_reg, user_mod, periodo_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap2Ind1 the static model class
	 */
