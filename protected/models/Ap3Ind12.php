...
/**
 * This is the model class for table "ap3Ind12".
 *
 * The followings are the available columns in table 'ap3Ind12':
 * @property integer $id
 ...
 */
class Ap3Ind12 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, anio, trimestre, delegacion, rubro, user_reg, user_mod', 'numerical', 'integerOnly'=>true),
			array('valor', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, anio, trimestre, delegacion, rubro, valor, fecha_reg, fecha_mod, user_reg, user_mod', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap3Ind12 the static model class
	 */
