...
/**
 * This is the model class for table "ap5Ind4".
 *
 * The followings are the available columns in table 'ap5Ind4':
 * @property integer $id
 ...
 */
class Ap5Ind4 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap5Ind4 the static model class
	 */
