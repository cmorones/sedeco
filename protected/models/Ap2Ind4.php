...
/**
 * This is the model class for table "ap2Ind4".
 *
 * The followings are the available columns in table 'ap2Ind4':
 * @property integer $id
 ...
 */
class Ap2Ind4 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap2Ind4 the static model class
	 */
