...
/**
 * This is the model class for table "ap2Ind3".
 *
 * The followings are the available columns in table 'ap2Ind3':
 * @property integer $id
 ...
 */
class Ap2Ind3 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap2Ind3 the static model class
	 */
