...
/**
 * This is the model class for table "ap1Ind4a_hist".
 *
 * The followings are the available columns in table 'ap1Ind4a_hist':
 * @property integer $id
 ...
 */
class Ap1Ind4aHist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind4aHist the static model class
	 */
