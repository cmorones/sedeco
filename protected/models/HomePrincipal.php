...
class HomePrincipal extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('titulo, subtutulo, activo, nombre_btn, archivo, fecha_reg, fecha_mod, _archivo', 'safe'),
           ...
           // array('_archivo', 'file', 'types'=>'xls', "allowEmpty"=>true,'maxSize'=>1024 * 1024 * 2,  'tooLarge'=>'Archivo debe ser menor a 2mb', "on"=>"update"),
			...
			array('id, titulo, subtutulo, activo, nombre_btn, archivo, fecha_reg, fecha_mod, user_reg, user_mod', 'safe', 'on'=>'search'),
		);
	}
