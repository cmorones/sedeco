...
/**
 * This is the model class for table "ap1Ind71".
 *
 * The followings are the available columns in table 'ap1Ind71':
 * @property integer $id
 ...
 */
class Ap1Ind71 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, entidad, anio, mes, user_reg, user_mod, columna, periodo_id', 'numerical', 'integerOnly'=>true),
			array('valor', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, entidad, valor, anio, mes, fecha_reg, fecha_mod, user_reg, user_mod, columna, periodo_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap1Ind71 the static model class
	 */
	...
	{
		 return CHtml::dropDownList('listname', $select, 
              array(
              	'0' => 'Total Nacional', 
              	'1' => 'Female'),
