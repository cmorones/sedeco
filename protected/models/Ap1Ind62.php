...
/**
 * This is the model class for table "ap1Ind62".
 *
 * The followings are the available columns in table 'ap1Ind62':
 * @property integer $id
...
class Ap1Ind62 extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, mes, anio, rubro, user_reg, user_mod, periodo_id', 'numerical', 'integerOnly'=>true),
			array('valor', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, mes, anio, rubro, valor, fecha_reg, fecha_mod, user_reg, user_mod, periodo_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap1Ind62 the static model class
	 */
