...
/**
 * This is the model class for table "ap6Ind2".
 *
 * The followings are the available columns in table 'ap6Ind2':
 * @property integer $id
 * @property double $df
 ...
 */
class Ap6Ind2 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, anio, user_reg, user_mod, periodo_id', 'numerical', 'integerOnly'=>true),
			array('df, nacional', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, df, nacional, anio, fecha_reg, fecha_mod, user_reg, user_mod, periodo_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap6Ind2 the static model class
	 */
