...
class Ap1Ind2b extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('periodo_id, id_entidad, id_sector, anio, user_reg, user_mod', 'numerical', 'integerOnly'=>true),
			array('valor', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, periodo_id, id_entidad, id_sector, anio, valor, fecha_reg, fecha_mod, user_reg, user_mod', 'safe', 'on'=>'search'),
		);
	}
