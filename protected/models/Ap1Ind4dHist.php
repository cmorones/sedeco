...
/**
 * This is the model class for table "ap1Ind4d_hist".
 *
 * The followings are the available columns in table 'ap1Ind4d_hist':
 * @property integer $id
 ...
 */
class Ap1Ind4dHist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind4dHist the static model class
	 */
