 ...
 * @property double $remuneraciones_n_me
...
class Ap8Ind11 extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, anio, mes, user_reg, user_mod, periodo_id', 'numerical', 'integerOnly'=>true),
			array('p_ocupadas_n_ma, p_ocupadas_df_ma, p_ocupadas_n_me, p_ocupadas_df_me, remuneraciones_n_ma, remuneraciones_df_ma, remuneraciones_n_me, remuneraciones_df_me, remuneraciones_pp_n_ma, remuneraciones_pp_df_ma, remuneraciones_pp_n_me, remuneraciones_pp_df_me, ingreso_n_ma, ingreso_df_ma, ingreso_n_me, ingreso_df_me, compras_n_ma, compras_df_ma, compras_n_me, compras_df_me', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, anio, mes, p_ocupadas_n_ma, p_ocupadas_df_ma, p_ocupadas_n_me, p_ocupadas_df_me, remuneraciones_n_ma, remuneraciones_df_ma, remuneraciones_n_me, remuneraciones_df_me, remuneraciones_pp_n_ma, remuneraciones_pp_df_ma, remuneraciones_pp_n_me, remuneraciones_pp_df_me, ingreso_n_ma, ingreso_df_ma, ingreso_n_me, ingreso_df_me, compras_n_ma, compras_df_ma, compras_n_me, compras_df_me, fecha_reg, fecha_mod, user_reg, user_mod, periodo_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'anio' => 'Año',
			'mes' => 'Mes',
			'p_ocupadas_n_ma' => 'P. Ocupadas Nacional Mayoreo',
			'p_ocupadas_df_ma' => 'P Ocupadas Df Mayoreo',
			'p_ocupadas_n_me' => 'P Ocupadas Nacional Menudeo',
			'p_ocupadas_df_me' => 'P Ocupadas Df Menudeo',
			'remuneraciones_n_ma' => 'Remuneraciones Nacional Mayoreo',
			'remuneraciones_df_ma' => 'Remuneraciones Df Mayoreo',
			'remuneraciones_n_me' => 'Remuneraciones Nacional Menudeo',
			'remuneraciones_df_me' => 'Remuneraciones Df Menudeo',
			'remuneraciones_pp_n_ma' => 'Remuneraciones Pp Nacional Mayoreo',
			'remuneraciones_pp_df_ma' => 'Remuneraciones Pp Df Mayoreo',
			'remuneraciones_pp_n_me' => 'Remuneraciones Pp Nacional Menudeo',
			'remuneraciones_pp_df_me' => 'Remuneraciones Pp Df Menudeo',
			'ingreso_n_ma' => 'Ingreso Nacional Mayoreo',
			'ingreso_df_ma' => 'Ingreso Df Mayoreo',
			'ingreso_n_me' => 'Ingreso Nacional Menudeo',
			'ingreso_df_me' => 'Ingreso Df Menudeo',
			'compras_n_ma' => 'Compras Nacional Mayoreo',
			'compras_df_ma' => 'Compras Df Mayoreo',
			'compras_n_me' => 'Compras Nacional Menudeo',
			'compras_df_me' => 'Compras Df Menudeo',
			'fecha_reg' => 'Fecha Reg',
			'fecha_mod' => 'Fecha Mod',
			'user_reg' => 'User Reg',
			'user_mod' => 'User Mod',
	...
	public function search($id)
	{
		...
		$criteria->compare('remuneraciones_n_me',$this->remuneraciones_n_me);
