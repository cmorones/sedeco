...
/**
 * This is the model class for table "ap5Ind1".
 *
 * The followings are the available columns in table 'ap5Ind1':
 * @property integer $id
 ...
 */
class Ap5Ind1 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, entidad, rubro, anio, mes, user_reg, user_mod, periodo_id', 'numerical', 'integerOnly'=>true),
			array('valor', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, entidad, valor, rubro, anio, mes, fecha_reg, fecha_mod, user_reg, user_mod, periodo_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap5Ind1 the static model class
	 */
