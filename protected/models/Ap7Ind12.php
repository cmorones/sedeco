...
/**
 * This is the model class for table "ap7Ind12".
 *
 * The followings are the available columns in table 'ap7Ind12':
 * @property integer $id
 ...
 */
class Ap7Ind12 extends CActiveRecord
{
	/**
	 ...
	 * @return Ap7Ind12 the static model class
	 */
