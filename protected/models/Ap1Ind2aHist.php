...
/**
 * This is the model class for table "ap1Ind2a_hist".
 *
 * The followings are the available columns in table 'ap1Ind2a_hist':
 * @property integer $id
 ...
 */
class Ap1Ind2aHist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind2aHist the static model class
	 */
